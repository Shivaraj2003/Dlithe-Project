    ...
    <div class="container-fluid p-0 m-0 ">
        ...
        <div class="body-content ">
            ...
            <div class="sidebar-nav bg-body-tertiary p-5">
                ...
                <a href="removeBus.jsp" class="btn btn-outline-warning p-2">Remove Bus</a>
                <a href="adminActivity.jsp" class="btn btn-outline-warning p-2">Home</a>
            </div>

            <div class="content-part bg-body-tertiary ">
                <form action="removeTripServlet" method="post">
                    <table>
                        <tr>
                            <th>
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" id="tripId" name="tripId"><br><br>
                            </td>
                        </tr>
                    </table>
